...
public class Board {
    ...
    private void fillBase() {
        System.out.println("board 1 -> "+board+" length => "+board.length);
        for (int i = 0; i < board.length; i++) {

            System.out.println("board 2 -> "+board+" length => "+board[i].length);
    ...
    private void fillBlacks() {
        for (int i = 5; i < 8; i++) {
            System.out.println("Player 1 => i - "  + i);
            for (int j = 0; j < board[i].length; j++) {
                System.out.println("Player 1 => j - "  + j);
                if (j % 2 == 0) {
                    if (i == 6) {
